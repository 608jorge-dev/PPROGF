...
OBJECTS=character.o command.o game_actions.o game_loop.o game_reader.o game.o graphic_engine.o object.o player.o set.o space.o 
...
game.o: game.c game.h command.h types.h player.h object.h space.h set.h character.h game_reader.h
	$(CC) $(CFLAGS) -c game.c
