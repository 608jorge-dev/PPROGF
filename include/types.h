...
#define ALL_SPACES -2  /*!< Id to open all links */
...
#define N_CMD 13      /*!< Max amount of characters a command can have */
...
/**
 * @brief All 6 cardinal directions enumeration.
 */
typedef enum
{
    N,
